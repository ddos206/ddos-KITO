...
print ('''
	   /////    /////    /////////////
	  chien/   chien/   | kito-attack |/
	 kito/      kito/       |-----------|/ 
	 kito/      kito/       |  Layer 7  |/ 
	 kito/////  kito/////   | ddos tool |/ 
	  chien/   chien/   |___________|/
>--------------------------------------------->
Version 3.7.1 (2022/3/24)
                              C0d3d by chien
			      and some minor changes by ndbiaw
┌─────────────────────────────────────────────┐
...
│          [+] 4607102006                     │
├─────────────────────────────────────────────┤
│ Link: https://github.com/ddos206/ddos-KITO/ │
└─────────────────────────────────────────────┘''')
...
def main():
	...
	period = 60
	help = False
	print("> Mode: [kito/post/head]")#slow]")
	for n,args in enumerate(sys.argv):
		...
		if args=="-m" or args=="-mode":
			mode = sys.argv[n+1]
			if mode not in ["kito","post","head"]:#,"slow"]:
